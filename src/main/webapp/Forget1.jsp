 ...
 <header class="header-area header-sticky" style="background-color:#687EFF">
	...
	<div class="container mt-5  main p-5 offset-4">
        ...
        <div class="row">
            ...
            <div class="row mt-4">
                <div class="col-md-4"><input type="text" class="form-control" name="otp" placeholder="enter your otp"></div>
            </div>
            <div class="row mt-4" style="margin-left: 150px;">
                <div class="col-md-5"><button type="submit" class="btn btn-outline-info">Submit</button>
                    </div>
            </div>
        </form>
    </div>
